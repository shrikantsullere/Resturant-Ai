          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-landing-primary transition-all text-white font-medium" 
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select 
                      ...
                      onChange={handleInputChange}
                      className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-landing-primary transition-all text-white font-medium appearance-none"
                    >
                      <option value="2" className="bg-dark">2 Persons</option>
                      <option value="4" className="bg-dark">4 Persons</option>
                      <option value="6" className="bg-dark">6 Persons</option>
                      <option value="8" className="bg-dark">8+ Persons</option>
                    </select>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full btn-premium py-5 rounded-2xl flex items-center justify-center gap-3 text-xs font-black uppercase tracking-[0.2em] shadow-2xl shadow-landing-primary/20 group disabled:opacity-50"
              >
