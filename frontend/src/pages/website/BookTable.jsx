                    ...
                    <div className="space-y-6">
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                             ...
                             <input 
                               ...
                               onChange={handleInputChange}
                               placeholder="+00 000..." 
                               className="w-full px-6 py-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-orange-500 focus:bg-white transition-all text-sm font-bold" 
                             />
                          </div>
                       </div>
                       <div>
                       ...
                       <div>
                          ...
                          <textarea 
                             ...
                             className="w-full px-6 py-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-teal-500 focus:bg-white transition-all text-sm font-bold resize-none"
                           ></textarea>
                       </div>
                    </div>
