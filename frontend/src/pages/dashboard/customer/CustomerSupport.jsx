    ...
    <div className="space-y-6 lg:space-y-8 pb-20">
      ...
      {toast && (
        <div className={cn(
          ...
          toast.type === 'success' ? "bg-primary border-primary/20 text-white" : "bg-rose-500 border-rose-500/20 text-white"
        )}>
      ...
      {activeModal && createPortal(
        <div className="fixed inset-0 z-[10000] flex flex-col justify-end sm:justify-center items-center sm:p-4 overflow-hidden">
          ...
          {/* Create Ticket Modal */}
          {activeModal === 'ticket' && (
            <div className="relative w-full sm:max-w-[500px] bg-white rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl overflow-hidden animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-300 flex flex-col max-h-[90dvh] sm:max-h-[85vh] mt-auto sm:mt-0">
          ...
          {activeModal === 'chat' && (
            <div className="relative w-full sm:max-w-[420px] bg-white rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.2)] overflow-hidden flex flex-col h-[90dvh] sm:h-[600px] animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-500 mt-auto sm:mt-0 border-x border-t sm:border border-slate-100">
               {/* Premium Header */}
               ...
               {/* Premium Input Area */}
               <div className="p-4 sm:p-6 bg-white border-t border-slate-50 shrink-0 pb-safe">
                  <form onSubmit={handleSendMessage} className="relative flex items-center gap-3">
                     <div className="relative flex-1 group">
                        <input 
                          ...
                          className="w-full pl-6 pr-12 py-4 sm:py-5 bg-slate-50 border-2 border-transparent focus:border-primary/10 focus:bg-white rounded-3xl outline-none font-bold text-xs transition-all placeholder:text-slate-300 shadow-inner group-hover:bg-slate-100/50"
                        />
