          ...
          {filteredItems.length > 0 ? (
            filteredItems.map(item => (
              <div 
                ...
                className="card group cursor-pointer border-2 border-transparent hover:border-primary/20 p-3 lg:p-5 flex flex-col relative overflow-hidden bg-gradient-to-br from-white to-slate-50/30 min-h-[320px] lg:min-h-[380px] h-full transition-all hover:shadow-xl hover:-translate-y-1 active:scale-95"
              >
                {/* Image Section */}
